...
hi SpecialKey guifg=yellowgreen"#ef2929
...
hi Constant guifg=yellowgreen"#8ae234
hi link Number Statement"guifg=#8ae234
...
hi link javaScriptOperator Number "guifg=#888a85
hi javaScriptYuiPackage guifg=#9f65c4"#8a0fd7"#ff5500
hi link javaScriptBoolean Number
hi link javaScriptIdentifier Number 
hi javaScriptYuiMethod guifg=#c4b365
" HTML
hi htmlTag guifg=#888a85
hi htmlEndTag guifg=#888a85
hi htmlTagName guifg=#babdb6
hi htmlSpecialTagName guifg=#babdb6
hi htmlArg guifg=#d3d7cf "yellowgreen 
hi htmlTitle guifg=#bbbbbb gui=none
